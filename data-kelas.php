									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<?php foreach ($dataKelas as $kelas) : ?>
												<?php 
												if ($kelas["jurusan"] == "AP") {
													$kelas["jurusan"] = "Administrasi Perkantoran";
												} elseif ($kelas["jurusan"] == "AK") {
													$kelas["jurusan"] = "Akuntansi";
												} elseif ($kelas["jurusan"] == "PM") {
													$kelas["jurusan"] = "Pemasaran";
												} elseif ($kelas["jurusan"] == "MM") {
													$kelas["jurusan"] = "Multimedia";
												}
												?>
												...
												<tr>
													...
													<td><?= $kelas["jurusan"]; ?></td>
													<td>
														<a href="#" title="Edit" class="btn btn-warning">EDIT</a>
														<a href="<?= BASE_URL . 'data-kelas-delete.php?kode_kelas=' . $kelas["kode_kelas"] ?>" title="Delete" class="btn btn-danger">DELETE</a>
													</td>
												</tr>
