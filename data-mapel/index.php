...
$query = ("SELECT tb_mapel.kode_mapel, tb_mapel.nama_mapel, tb_jurusan.nama_jurusan FROM tb_mapel INNER JOIN tb_jurusan ON tb_mapel.kategori_mapel = tb_jurusan.kode_jurusan ORDER BY tb_mapel.kategori_mapel");
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="card-title">
										<a href="data-mapel-add.php" title="Data Mata Pelajaran Add" class="btn btn-primary">Tambah Data Mata Pelajaran</a>
									</div>
									<br><br>
										...
										<tbody>
											<?php foreach ($dataMapel as $mapel) : ?>
												<tr>
													...
													<td>
														<a href="<?= BASE_URL . 'data-mapel/data-mapel-edit.php?kode_mapel=' . $mapel["kode_mapel"] ?>" title="Edit" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a>
														<a href="javascript:void(0)" class="btn btn-danger" id="data-row" data-id="<?= $mapel['kode_mapel'] ?>" title="Delete"><i class="fas fa-trash"></i></a>
													</td>
												</tr>
			...
			Swal.fire({
				...
				preConfirm: function(){
					return new Promise(function(resolve){
						$.ajax({
							url: 'data-mapel-delete.php',
							type: 'POST',
							data: 'kode_mapel='+dataRow
						})
