										...
										<tbody>
											<?php foreach ($dataMapel as $mapel) : ?>
												<tr>
													...
													<td>
														<a href="<?= BASE_URL . 'data-mapel/data-mapel-edit.php?kode_mapel=' . $mapel["kode_mapel"] ?>" title="Edit" class="btn btn-warning">EDIT</a>
														<a href="<?= BASE_URL . 'data-mapel/data-mapel-delete.php?kode_mapel=' . $mapel["kode_mapel"] ?>" title="Delete" class="btn btn-danger" onclick="return confirm('Apakah kamu yakin ingin menghapus data ini?');">DELETE</a>
													</td>
												</tr>
